...
Report the classification to the user ("Vue needed: yes/no, Astro needed: yes/no") and pause for acknowledgement before proceeding. If both are empty, stop with "no runtime changes since last deploy — nothing to ship".
