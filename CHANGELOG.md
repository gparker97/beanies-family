...
- **Share your meal plan as a picture or a PDF.** Alongside the existing text copy, the meal planner's Share now offers **Share** — a friendly one-page picture of the whole week handed to your phone's share sheet (WhatsApp, Messages, email) — and **Export as PDF**, which downloads the same page for printing and sticking on the fridge. Both are made on your device; nothing about your plan is uploaded to create them.
