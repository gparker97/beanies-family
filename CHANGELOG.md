...
- **The shower is a burst now, not a drift.** It fell in slow motion and eased to a halt, which looked like the pieces floating rather than falling. It now accelerates the way falling things do, lands in about half the time, arrives together instead of in a queue, and settles with a small bounce.
