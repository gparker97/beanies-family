...
- **The iPhone app no longer gets stuck zoomed-in during setup and onboarding.** Some form fields in the setup and onboarding steps rendered smaller than iPhone's threshold for auto-zooming into a tapped field — and iOS didn't reliably zoom back out, leaving the whole app stuck zoomed until you force-quit it. Those fields are now sized so the auto-zoom never triggers. Pinch-to-zoom still works everywhere, and Large reading mode is unaffected.
