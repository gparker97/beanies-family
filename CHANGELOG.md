...
- **The confetti in a celebration's details pane falls again.** Opening a birthday was meant to rain beans in from above and settle them. It never did: the confetti animation is spent once per activity per session to stop it twitching every time a card scrolls back into view, and the chip you tap to open the drawer had already spent it. Cards still animate once; a drawer now rains every time you open it.
