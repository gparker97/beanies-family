...
- **Clearing a day is easier to hit.** The button sat on top of the day's name; it now has its own space above it, and it shows up on a tablet rather than only on hover.
