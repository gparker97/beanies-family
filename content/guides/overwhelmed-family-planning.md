...
[beanies.family](https://beanies.family) is what we ended up using, which is pretty obvious, since I built it.

It's a complete family + financial planning solution that is fully local-first and private. It keeps data on your device, not on somebody else's server, and it marries up your finances with your family, so to speak. I'm clearly biased though - try a few solutions yourself before you decide.
