...
> **Last updated:** 2026-04-23 (all-day marketing-site rebuild + FAB ship + nav overhaul + content sync — ~25 commits, multiple prod deploys)
> **Updated by:** Claude (2026-04-23 afternoon/evening session covered — massive marketing-site + content + FAB shipping day, deployed in multiple waves across `https://app.beanies.family` and `https://beanies.family`).
>
