...
- **Exactly one matrix cell changes.** Open-stage throw with no document and no ready cache: refuse → adopt. Every other cell keeps today's verdict. If a change makes a second cell move, the change is wrong.
