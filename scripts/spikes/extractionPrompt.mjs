 ...
 */
export const RECIPE_POLICY_LINES = [
 ...
 * was consumed.
 *
 * Mirrored byte-for-byte with the client (`src/services/ai/extractionPrompt.ts`) and the
 * Lambda; the drift test pins all three, for both reasons.
 */
const HINT_CONTEXT = {
