  ...
  >
    ...
    <FormFieldGroup :label="t('memberNotes.field.body')" required>
      <textarea
        v-model="body"
        rows="6"
        class="focus:border-primary-500 focus:ring-primary-500 font-outfit dark:border-line-strong dark:bg-surface-overlay dark:text-ink w-full rounded-xl border-2 border-[var(--tint-slate-10)] bg-white px-4 py-3 text-base leading-relaxed text-[var(--color-text)] outline-none focus:ring-1"
