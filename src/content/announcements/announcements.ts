...
export const ANNOUNCEMENTS: Announcement[] = [
  {
    ...
    message: {
      en: "There's nothing I love more than my super precious early-adopter beanies. You are a key part of the evolution of beanies, and I'd love to know what you like (or hate) about our lovely app so I can make it better. Join me on Discord - I'm there all the time, so if you see anything good, bad, or ugly about the platform you can report it to me directly. Feedback, bugs, error reports, etc - it's all good. Hope to see you there!",
      beanie:
        "there's nothing i love more than my super precious early adopter beanies. you are a key part of the evolution of beanies, and i'd love to know what you like (or hate) about our lovely app so i can make it better. join me on discord - i'm there all the time, so if you see anything good, bad, or ugly about the platform you can report it to me directly. feedback, bugs, error reports, etc - it's all good. hope to see you there!",
    },
    note: {
